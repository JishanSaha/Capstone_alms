...
Route::controller(AdminController::class)->prefix('admin')->as('admin.')->group(function() {
    ...
    Route::group(['middleware'=>'admin'],function(){
        ...
        Route::get('employee_leave_status_approve/{id}','employee_leave_status_approve')->name('employee_leave_status_approve');
        Route::get('employee_leave_status_disapprove/{id}','employee_leave_status_disapprove')->name('employee_leave_status_disapprove');
