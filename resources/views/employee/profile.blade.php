            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <label for="validationContactNumber" class="form-label">Contact Number</label>
                            <input type="text" class="form-control" id="validationContactNumber" name="personal_phone" value="{{ $employee_info->personal_phone }}" disabled>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <div class="col-md-4">
                            <label for="validationSin" class="form-label">Sin</label>
                            <input type="text" class="form-control" id="validationSin" name="sin" value="{{ $employee_info->sin }}" disabled>
                        </div>
                        <div class="col-md-4">
